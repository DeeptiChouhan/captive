...
class CustomerPage:
    ...
    def __init__(self, page: Page):
        ...
        self.customers_button = page.locator("a[href='/users/customers']").first

        # Add Customer Button
        self.add_customer_button = page.locator("a[href='/users/customers/create']")
    ...
    def submit_customer_form(self):
        ...
        try:
            self.page.wait_for_url('**/users/customers', timeout=7000)
            return True
        except Exception:
            return False
